...
public class PickUpScript : MonoBehaviour
{
    ...
    private float rotationSensitivity = 10f; //how fast/slow the object is rotated in relation to mouse movement
    ...
    void Start()
    {
        ...
        mouseLookScript = player.GetComponent<LookAround>();
    ...
    void PickUpObject(GameObject pickUpObj)
    {
        if (pickUpObj.GetComponent<Rigidbody>()) //make sure the object has a RigidBody
        {
            ...
            SetLayerRecursively(heldObj, LayerNumber); // Change the object layer to the holdLayer
    ...
    void DropObject()
    {
        ...
        SetLayerRecursively(heldObj, 0); // Assign object back to default layer
    ...
    void RotateObject()
    {
        if (Input.GetKey(KeyCode.Mouse1))//hold R key to rotate, change this to whatever key you want
        {
            ...
            mouseLookScript.sensitivity = 0f;
